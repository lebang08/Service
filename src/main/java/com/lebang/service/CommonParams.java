...
public class CommonParams {
    ...
    /**
     * 安卓WiFi-Direct连接手机端参数
     */
    public static final String SERVICE_INSTANCE = "_ClfWfd";
    public static final String SERVICE_REG_TYPE = "_Clf._Wifi";
    ...
    public static final int MSG_CONNECT_DELAY_USBMUXD = 1111;
    ...
    public static final int MSG_WIFI_ANDROID_CONNECT_INIT = 1027;
    ...
    public static final String SERVER_ANDROID_WIFI_URL = "192.168.43.1";//ap point Ip is : 192.168.43.228
    ...
    public static final String appPkgAuto = "com.autonavi.amapauto";
    public static final String appPkgJYUNT = "cn.jyuntech.map";
    public static final String activityClsJYUNT = "cn.jyuntech.mainmenu.MapActivity";
    public static final String activityClsAuto = "com.autonavi.auto.MainMapActivity";
    public static final String appName = "CarLife";
    public static final String voiceChannel = "Music";
    public static final String ttsChannel = "TTS";
    public static final String vrChannel = "VR";
    public static int PRIORITY_BHORN_MEDIA = 1;
    public static boolean mIsCanAudioTTS = true;
    public static boolean mIsInCarlife = false;
    public static boolean mIsBTHappen = false;
    public static boolean mIsCommandPause = false;
    ...
    //福田 前装项目
    public static final String VEHICLE_CHANNEL_FOTON = "20592105";
